        ...
        <>
            ...
            <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 p-6 text-center">
                <div className="w-full max-w-md space-y-6">
                    {/* Error code */}
                    <h1 className="text-primary text-9xl font-extrabold">500</h1>
                ...
                {/* Footer message */}
                <p className="text-muted-foreground mt-10 text-sm">If this issue persists, please contact support.</p>
            </div>
        </>
    );
}
